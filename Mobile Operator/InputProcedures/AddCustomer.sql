...
BEGIN
	...
	INSERT INTO Customers(MonthsOfContract, DateJoinded, LastSubscriptionDate, MobilePlanType, DateQuit, OwedMoney, ProblemCount)
	VALUES (@MonthsOfContract, @DateJoinded, @LastSubscriptionDate, @MobilePlanType,@DateQuit, @OwedMoney, @ProblemCount)
